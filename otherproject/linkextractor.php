...
<h3 class="pt-4 pb-4 text-center"  style="background-color:#e2b13c; color:#fff;">Link Extractor </h3> 
...
<div class="col-md-2">
<button type="submit" name="save" class=" btn" style="background-color:#e2b13c; color:#fff;">Submit</button>
</div>
<div class="col-md-2">
</div>
...
echo "<script>window.location='login.php?t=link';</script>";
	...
	$url=$_POST['link'];
	$sql="Insert into toolused (name,usedon,usedby,url)values('linkextractor','$dt','$_SESSION[uid]','$_POST[link]')";
