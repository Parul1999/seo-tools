...
<h3 class="pt-4 pb-4 text-center bg-info text-light" > Keyword Extractor </h3> 
<div class="container">
<div class="row">
<div class="col-md-12">
...
<h5> <a href="#" data-toggle="modal" data-target="#exampleModalLong" style="color:#17a2b8"> Know More About Keyword Extractor </a> </h5>
</div>
</div><br/>
...
echo "<script>window.location='login.php?t=key';</script>";
	...
	$url=$_POST['url2'];
	$sql="Insert into toolused (name,usedon,usedby,url)values('keyword-extractor','$dt','$_SESSION[un]','$_POST[url2]')";
